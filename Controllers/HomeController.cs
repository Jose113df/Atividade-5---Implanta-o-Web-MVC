...
using THESPet.Models;

namespace THESPet.Controllers;
...
public class HomeController : Controller
{
    ...
    {
        //Tipo Cliente intancias
        Cliente cliente1 = new Cliente(01, "José M", "123.123.321-12", "jm@gmail.com", "Fofinho");
